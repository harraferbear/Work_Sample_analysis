...
full_20 = read.csv("C:\\Users\\EugLu\\Desktop\\HW\\DS perspective\\project2\\601_project\\601_shiny\\data\\bikes_2020_full.csv") %>% dplyr::filter(Month<=10) %>% na.omit()
...
full_19 = read.csv("C:\\Users\\EugLu\\Desktop\\HW\\DS perspective\\project2\\601_project\\601_shiny\\data\\bike_2019_full.csv") %>% na.omit()
nearest_stations  = read.csv("C:\\Users\\EugLu\\Desktop\\HW\\DS perspective\\project2\\601_project\\601_shiny\\data\\nearest_stations.csv")
